...
eResult Irisha::SQUIT(const int sock)
{
	...
	if (cmd_.prefix_ == "")
		send_msg(choose_sock(server), connection_name(sock), "SQUIT " + cmd_.arguments_[0] + " :" + cmd_.arguments_[1]);
	else
		send_msg(choose_sock(server), "SQUIT " + cmd_.arguments_[0] + " :" + cmd_.arguments_[1]);
